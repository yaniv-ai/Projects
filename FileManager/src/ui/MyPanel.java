...
public class MyPanel extends JPanel {
	...
	// TODO find how to override getModifiers();
	protected void fireActionPerformed() {
		...
		ActionEvent e = new ActionEvent(this, ActionEvent.ACTION_PERFORMED,
				(command != null) ? command : this.getClass().toString(), EventQueue.getMostRecentEventTime(),
				modifiers);
	...
	private static class MyPanelActionPropertyChangeListener extends MyActionPropertyChangeListener<MyPanel> {
		...
		@Override
		protected void actionPropertyChanged(MyPanel myPanel, Action action, PropertyChangeEvent e) {
	 ...
	 * 
	 * @return the <code>Action</code> for this <code>ActionEvent</code> source, or
	 *         <code>null</code>
	 * @since 1.3
	 * @see Action
	 * @see #setAction
	 ...
	 * Components Supporting <code>Action</code></a> for more details as to which
	 * properties this sets.
	 * 
	 * @param a the <code>Action</code> from which to get the properties, or
	 *          <code>null</code>
	 * @since 1.3
	 * @see Action
	 * @see #setAction
	 ...
	 * action. This method is invoked from the {@code PropertyChangeListener}
	 * returned from {@code createActionPropertyChangeListener}. Subclasses do not
	 * normally need to invoke this. Subclasses that support additional
	 * {@code Action} properties should override this and
	 * {@code configurePropertiesFromAction} .
	 * <p>
	 * Refer to the table at <a href="Action.html#buttonActions"> Swing Components
	 * Supporting <code>Action</code></a> for a list of the properties this method
	 * sets.
	 * 
	...
	/**
	 * Processes action events occurring on this textfield by dispatching them to
	 * any registered <code>ActionListener</code> objects. This is normally called
	 * by the controller registered with textfield.
	 */
